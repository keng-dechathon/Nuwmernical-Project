...
export default function GuassEliminate() {
    random_bg_color();
    const initial = {
        size: '',
        showInput: false,
            ...
            <MatrixBox>
                <MatrixInputBox>
                    ...
                    <Flexbox>
                        ...
                        <Matrix2 style={{ width: '10%', marginLeft: '25px' }}>
                            <h3 >Matrix B</h3>
                            {showInput && inputB}
                        </Matrix2>
                    </Flexbox>
